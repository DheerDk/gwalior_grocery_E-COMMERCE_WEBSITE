    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <h4>Gwalior Grocery is a leading online grocery store in the Gwalior. We are committed to providing the best quality products at the best prices.</h4>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 Gwalior Grocery, Inc.  All rights reserved</h3>
