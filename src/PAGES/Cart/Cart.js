...
const Cart = () => {
  ...
  return (
    <div>
      ...
      {
        ordersuccesscont && <OrderSuccessful orderid={selectedorderid} message={`Order Placed Successfully, Order ID: RS{selectedorderid}`}  redirecto='userorders'/>
      }
      <SingleBanner
        heading="My Cart"
                          ...
                          <tr key={index} className="cartitemrow">
                            ...
                            >
                              <div className='cartproduct'
                                onClick={() => {
                                  window.location.href = `/product/RS{item.productdata.ProductId}`
                                }}
                              >
